    ...
    */
    ...
    public void getHighScore () {
         try {
             ...
             //input
             BufferedReader in = new BufferedReader(new FileReader("highScore/highScore.txt"));
             ...
             if(numOfEnemiesKilled > highScore){
            	 try {
                     BufferedWriter out = new BufferedWriter(new FileWriter("highScore/highScore.txt"));
